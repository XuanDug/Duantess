...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.Maluong).HasName("PK__BANGLUON__D9BA4D002B7CA69C");
        ...
        {
            entity.HasKey(e => e.Machatlieu).HasName("PK__CHATLIEU__80F939F8972B2020");
        ...
        {
            entity.HasKey(e => e.Machucvu).HasName("PK__CHUCVU__9FA9FD6AF4F3BB16");
        });

        modelBuilder.Entity<Giaoca>(entity =>
        {
            entity.HasKey(e => e.Magiaoca).HasName("PK__GIAOCA__7D3545CC3B0E7ACD");
        });

        modelBuilder.Entity<Giaocanhanvien>(entity =>
        {
            entity.HasKey(e => e.Magiaocanhanvien).HasName("PK__GIAOCANH__B0F1BCFDEE3F20F9");
        ...
        {
            entity.HasKey(e => e.Magiay).HasName("PK__GIAY__0C880C58B470AE44");
        });

        modelBuilder.Entity<Giaychitiet>(entity =>
        {
            entity.HasKey(e => e.Magiaychitiet).HasName("PK__GIAYCHIT__196AD703AC96379A");
        ...
        {
            entity.HasKey(e => e.Mahinhthucthanhtoan).HasName("PK__HINHTHUC__C3B2561F5CD7E7A3");
        });

        modelBuilder.Entity<Hoadon>(entity =>
        {
            entity.HasKey(e => e.Mahoadon).HasName("PK__HOADON__A4999DF58EE8A826");
        ...
        {
            entity.HasKey(e => e.Mahoadonchitiet).HasName("PK__HOADONCH__EF957FF0CEEA08EC");
        ...
        {
            entity.HasKey(e => e.Makhachhang).HasName("PK__KHACHHAN__30035C2FE0BCB0DC");
        });

        modelBuilder.Entity<Kichco>(entity =>
        {
            entity.HasKey(e => e.Makichco).HasName("PK__KICHCO__7EDFFF297ED1ED8E");
        ...
        {
            entity.HasKey(e => e.Makieudang).HasName("PK__KIEUDANG__877F27F2941D28E9");
        ...
        {
            entity.HasKey(e => e.Mamausac).HasName("PK__MAUSAC__99E7A68F5C8C412D");
        ...
        {
            entity.HasKey(e => e.Mataikhoan).HasName("PK__TAIKHOAN__2ED8B5173C39F794");
        ...
        {
            entity.HasKey(e => e.Mathuonghieu).HasName("PK__THUONGHI__B319F6381F879D7F");
        ...
        {
            entity.HasKey(e => e.Mauudai).HasName("PK__UUDAI__3F58B4FDD2AE0E45");
