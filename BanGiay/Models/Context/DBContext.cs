...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source= ADMIN ;Initial Catalog= DBGIAY_DUAN1;Integrated Security=True;TrustServerCertificate=true");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Bangluong>(entity =>
        {
            entity.HasKey(e => e.Maluong).HasName("PK__BANGLUON__D9BA4D00E50144E7");
        ...
        {
            entity.HasKey(e => e.Machatlieu).HasName("PK__CHATLIEU__80F939F841AE948E");
        ...
        {
            entity.HasKey(e => e.Machucvu).HasName("PK__CHUCVU__9FA9FD6A48B3DFE8");
        });

        modelBuilder.Entity<Giaoca>(entity =>
        {
            entity.HasKey(e => e.Magiaoca).HasName("PK__GIAOCA__7D3545CC57563D9D");
        });

        modelBuilder.Entity<Giaocanhanvien>(entity =>
        {
            entity.HasKey(e => e.Magiaocanhanvien).HasName("PK__GIAOCANH__B0F1BCFDFF468416");
        ...
        {
            entity.HasKey(e => e.Magiay).HasName("PK__GIAY__0C880C589BF988CC");
        });

        modelBuilder.Entity<Giaychitiet>(entity =>
        {
            entity.HasKey(e => e.Magiaychitiet).HasName("PK__GIAYCHIT__196AD703EC9137F9");
        ...
        {
            entity.HasKey(e => e.Mahinhthucthanhtoan).HasName("PK__HINHTHUC__C3B2561F0E7EDC6B");
        });

        modelBuilder.Entity<Hoadon>(entity =>
        {
            entity.HasKey(e => e.Mahoadon).HasName("PK__HOADON__A4999DF5B73FC245");
        ...
        {
            entity.HasKey(e => e.Mahoadonchitiet).HasName("PK__HOADONCH__EF957FF0E1D14CC2");
        ...
        {
            entity.HasKey(e => e.Makhachhang).HasName("PK__KHACHHAN__30035C2FB042C2AF");
        });

        modelBuilder.Entity<Kichco>(entity =>
        {
            entity.HasKey(e => e.Makichco).HasName("PK__KICHCO__7EDFFF299D2A46F6");
        ...
        {
            entity.HasKey(e => e.Makieudang).HasName("PK__KIEUDANG__877F27F27A154028");
        ...
        {
            entity.HasKey(e => e.Mamausac).HasName("PK__MAUSAC__99E7A68FBECE59A7");
        ...
        {
            entity.HasKey(e => e.Mataikhoan).HasName("PK__TAIKHOAN__2ED8B517057552CF");
        ...
        {
            entity.HasKey(e => e.Mathuonghieu).HasName("PK__THUONGHI__B319F6388B52FB34");
        ...
        {
            entity.HasKey(e => e.Mauudai).HasName("PK__UUDAI__3F58B4FDB3D33A76");
